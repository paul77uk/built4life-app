...
// props is an object, it is short for properties
// in this case session is a property of props
// so we couldn't just put session as a parameter
// we need to destructure it from props
